...
public class BoardServiceImpl implements Service {
	...
	@Override
	public List<CommentVO> getCmtList(int bcno) {
		log.info("CmtList check2");
		return bdao.cmtSelectList(bcno);
	}
	...
	@Override
	public int addCmt(CommentVO cvo) {
		log.info("comment check 2");
		return bdao.insertCmt(cvo);
	}
